...
https://nadya-semyonova.github.io/products-app/products
...
# Jikan API имеет следующие ограничения:
- Лимит: 2 запроса в секунду, 30 в минуту 
- Первый запрос может занимать до 400+ мс из-за парсинга страниц 
- Возможны таймауты до 10 секунд при загрузке данных 

# Для оптимизации в проекте реализовано:
- Кэширование загруженных данных через флаг hasLoadedOnce
- Добавлен fallback на локальное изображение (заглушку)
